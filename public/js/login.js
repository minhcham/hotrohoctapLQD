var SnippetLogin=function(){
    var e=$("#m_login"),
        i=function(e,i,a){
        var l=$('' +
            '<div class="m-alert m-alert--outline alert alert-'+i+' alert-dismissible" role="alert">\t\t\t' +
            '<button type="button" class="close" data-dismiss="alert" aria-label="Close"></button>' +
            '\t\t\t<span></span>\t\t</div>');e.find(".alert").remove(),l.prependTo(e),mUtil.animateClass(l[0],"fadeIn animated"),
                l.find("span").html(a)},a=function(){e.removeClass("m-login--forget-password"),
